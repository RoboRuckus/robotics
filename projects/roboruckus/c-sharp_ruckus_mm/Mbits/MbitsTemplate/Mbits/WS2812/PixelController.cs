...
namespace WS2812
{
    public class PixelController
    {
        ...
        //pixels as binary command ready to be sent
        ...
        /// <summary>
        /// Update pixels that are changed before with SetColor method. Works fast.
        /// </summary>
        ...
        {
            //Every bit is represented as a command. Every command contains 4 bytes the first 2 bytes are for the high signal and the second 2 for the low.
            //In every pair the first is the duration of the signal and the second is the level of the signal high/low.
